...
module.exports = {
    ...
    async execute(client, interaction) {   
      ...
      let a = client.users.cache.get('1146450370218950666').tag
      let b = client.users.cache.get('1148225315034906644').tag
      let c = client.users.cache.get('1148225316402245632').tag
    ...
    //  osutils.cpuUsage(function(v) {
      ...
      .setTitle(`GladeUptime • İstatistikler`)
      .setColor("Blurple")
      .addFields({
        },
        {
