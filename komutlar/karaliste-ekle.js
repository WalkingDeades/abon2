...
module.exports = {
    ...
    async execute(client, interaction) {   
      ...
      if(interaction.user.id !== "1146450370218950666" && interaction.user.id !== "1148225315034906644" && interaction.user.id !== "1148225316402245632"  && interaction.user.id !== "1029431477219360869" && interaction.user.id !== "990186530767249419" && interaction.user.id !== "1059475189588570122"){
